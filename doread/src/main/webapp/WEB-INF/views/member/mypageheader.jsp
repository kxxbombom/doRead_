	...
	<div class="mypage-div">
		<ul>
			...
			<li>
				...
				<div class="myul">
					<ul>
						...
						<li><a href="${pageContext.request.contextPath}/book/bookFavList.do">회원 찜 목록</a></li>
			...
			<li>
				...
				<div class="myul">
						<ul>
							<li><a href="${pageContext.request.contextPath}/post/myPostList.do">내가 쓴 게시글 내역</a></li>
