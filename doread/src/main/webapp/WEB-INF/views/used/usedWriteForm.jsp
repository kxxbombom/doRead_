			    		...
			    		$.ajax({
			    			...
			    			success:function(param){
			    				if(param.result=='none'){
			    					...
			    					$('#add').append('<br><a href="${pageContext.request.contextPath}/qna/qnaWriteForm.do" style="height:35px; border-radius:5px; background-color:#FFF; color:rgb(26, 77, 46); font-size:15px; font-weight:bold; border:1px solid #4F6F52; cursor:pointer; padding:4px;">책등록요청하러가기</a>');
