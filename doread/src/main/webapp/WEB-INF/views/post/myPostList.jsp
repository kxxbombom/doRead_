	...
	<div class="content-main">
		...
		<table class="main-table">
			<tr class="main-tr">
				...
				<th class="main-td">제목</th>
				<th class="main-td">작성일</th>
				<th class="main-td">글등급
				</th>
			</tr>
			<c:forEach var="list" items="${list}">
			<tr>
				<td class="main-td">${list.u_num}</td>
				<td class="main-td"><a href="${pageContext.request.contextPath}/used/usedDetail.do?u_num=${list.u_num}" class="board-title">${list.u_title}</a></td>
				<td class="main-td">${list.u_rdate}</td>
				<td class="main-td">
		...
		<table class="main-table">
			<tr class="main-tr">
				...
				<th class="main-td">제목</th>
				<th class="main-td">작성일</th>
				<th class="main-td">글등급<img class="gideimage" src="${pageContext.request.contextPath}/images/question_471664.png"  width="15px">
				</th>
			</tr>
			<c:forEach var="Storylist" items="${Storylist}">
			<tr>
				<td class="main-td">${Storylist.s_num}</td>
				<td class="main-td"><a href="${pageContext.request.contextPath}/story/storyDetail.do?s_num=${Storylist.s_num}" class="board-title">${Storylist.s_title}</a></td>
				<td class="main-td">${Storylist.s_rdate}</td>
				<td class="main-td">
		...
		<table class="main-table">
			...
			<tr>
				<td class="main-td">${qna.q_num}</td>
				<td class="main-td"><a href="${pageContext.request.contextPath}/qna/qnaDetail.do?q_num=${qna.q_num}" class="QnA-title">${qna.q_title}</a></td>
				<td class="main-td">${qna.q_rdate}</td>
