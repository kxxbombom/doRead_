	...
	<ul>
		...
		<li>
			...
			<div class="group">
  				...
  				<input  style="margin-left:150px; width:800px;" class="input" type="search" placeholder="Search" />
  				<svg  style="margin-left:150px;" viewBox="0 0 24 24" aria-hidden="true" class="icon">
    			<g>
      			<path
