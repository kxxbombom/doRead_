	...
	<div class="content-main">
		...
		<div class="hide divv" id="adddiv">
			...
			<td>
				...
				출고예정일이란, 주문상품의 결제(무통장입금의 경우 입금확인)가 확인된 날 기준으로 상품을 준비하여 상품 포장 후 물류센터에서 택배사로 전달하게 되는 예상 일자 입니다.<br>
		...
		<div class="align-center">
			<input type="button" value=" 더보기" id="addbtn"><button onclick="location.href='#up'">위로가기</button>
		</div> 
